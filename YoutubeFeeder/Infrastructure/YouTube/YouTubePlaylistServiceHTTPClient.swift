...
struct YouTubePlaylistServiceHTTPClient {
    let dataLoader: @Sendable (URLRequest) async throws -> (Data, URLResponse)

    func loadData(for request: URLRequest, endpoint: String, metadata: [String: String]) async throws -> Data {
        let startedAt = Date()
    ...
    private func transportFailureMetadata(_ metadata: [String: String], endpoint: String, startedAt: Date, error: Error) -> [String: String] {
        metadata.merging(
            [
                "endpoint": endpoint,
    ...
    private func logTransportFailure(_ error: Error, metadata: [String: String], logger: AppConsoleLogger) {
    ...
    private func invalidResponseMetadata(_ metadata: [String: String], endpoint: String, startedAt: Date) -> [String: String] {
        metadata.merging(
