...
### Summary
- logic tests: 81 cases / 5.694s
- ui tests: 9 cases / 108.569s
- logic areas:
  - Browse: 7 cases / 0.006s
  - Formatting: 5 cases / 0.031s
  - Layout: 4 cases / 0.003s
  - Ordering: 5 cases / 0.006s
  - Parsing: 25 cases / 0.103s
  - Policies: 11 cases / 0.011s
  - Storage: 24 cases / 5.534s
- ui areas:
  - Browse: 7 cases / 69.459s
  - Home: 2 cases / 39.109s
