...
### Summary
- logic tests: 76 cases / 5.638s
- ui tests: 9 cases / 108.787s
- logic areas:
  - Browse: 7 cases / 0.006s
  - Formatting: 5 cases / 0.015s
  - Layout: 4 cases / 0.009s
  - Ordering: 5 cases / 0.006s
  - Parsing: 25 cases / 0.088s
  - Policies: 11 cases / 0.014s
  - Storage: 19 cases / 5.499s
- ui areas:
  - Browse: 7 cases / 69.598s
  - Home: 2 cases / 39.189s
