...
### Summary
- logic tests: 137 cases / 5.688s
- ui tests: 2 cases / 8.376s
- logic areas:
  - App: 4 cases / 0.002s
  - Browse: 21 cases / 0.012s
  - Formatting: 6 cases / 0.020s
  - Home: 9 cases / 0.009s
  - Layout: 10 cases / 0.004s
  - Ordering: 5 cases / 0.002s
  - Parsing: 31 cases / 0.039s
  - Policies: 18 cases / 0.014s
  - Storage: 33 cases / 5.586s
- ui areas:
  - Home: 2 cases / 8.376s
...
- ID: `YouTubeFeedParserTests.testFeedResponseDiagnosticsReportsFeedWithoutEntries`
- 概要: Feed Response Diagnostics Reports Feed Without Entries
- 分類: `logic` / `Parsing`
...
- ID: `YouTubeFeedParserTests.testFeedResponseDiagnosticsReportsHTMLResponse`
- 概要: Feed Response Diagnostics Reports HTML Response
- 分類: `logic` / `Parsing`
- ファイル: `YoutubeFeederTests/Unit/Parsing/YouTubeFeedParserTests.swift`
- 開始: `19:35:08`
- 終了: `19:35:08`
...
- ID: `YouTubeFeedParserTests.testFeedResponseDiagnosticsReportsParsedVideosPresent`
- 概要: Feed Response Diagnostics Reports Parsed Videos Present
- 分類: `logic` / `Parsing`
- ファイル: `YoutubeFeederTests/Unit/Parsing/YouTubeFeedParserTests.swift`
- 開始: `19:35:08`
- 終了: `19:35:08`
...
- ID: `ChannelRefreshSchedulePolicyTests.testFreshSnapshotMarksAllChannelsAsNotDueUntilTheirIntervalsExpire`
- 概要: Fresh Snapshot Marks All Channels As Not Due Until Their Intervals Expire
- 分類: `logic` / `Policies`
...
- ID: `ChannelRefreshSchedulePolicyTests.testMissingSnapshotStateIsDueImmediately`
- 概要: Missing Snapshot State Is Due Immediately
- 分類: `logic` / `Policies`
- ファイル: `YoutubeFeederTests/Unit/Policies/ChannelRefreshSchedulePolicyTests.swift`
- 開始: `19:35:03`
- 終了: `19:35:03`
...
- ID: `FeedCacheCoordinatorConcurrencyTests.testManualRefreshForcesNetworkFetchEvenWhenSnapshotIsFresh`
- 概要: Manual Refresh Forces Network Fetch Even When Snapshot Is Fresh
- 分類: `logic` / `Storage`
