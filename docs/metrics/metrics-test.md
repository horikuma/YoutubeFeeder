...
### Summary
- logic tests: 82 cases / 5.606s
- ui tests: 9 cases / 106.214s
- logic areas:
  - Browse: 8 cases / 0.008s
  - Formatting: 5 cases / 0.006s
  - Layout: 4 cases / 0.003s
  - Ordering: 5 cases / 0.006s
  - Parsing: 25 cases / 0.089s
  - Policies: 11 cases / 0.010s
  - Storage: 24 cases / 5.483s
- ui areas:
  - Browse: 7 cases / 68.048s
  - Home: 2 cases / 38.166s
...
- ID: `ChannelBrowseTipsSummaryTests.testBuildUsesDesktopMenuHintWhenMacInteractionOverrideIsSet`
- 概要: Build Uses Desktop Menu Hint When Mac Interaction Override Is Set
- 分類: `logic` / `Browse`
- ファイル: `YoutubeFeederTests/Unit/Browse/ChannelBrowseTipsSummaryTests.swift`
- 開始: `19:00:43`
- 終了: `19:00:43`
...
- 分類: `ui` / `Browse`
- ファイル: `YoutubeFeederUITests/Browse/BrowseScreenUITests.swift`
- 開始: `19:00:53`
- 終了: `19:01:08`
- 所要時間: `14.874s`
...
- ID: `BrowseScreenUITests.testRemoteSearchLiveRefreshCompletesOnDevice`
- 概要: Remote Search Live Refresh Completes On Device
- 分類: `ui` / `Browse`
- ファイル: `YoutubeFeederUITests/Browse/BrowseScreenUITests.swift`
- 開始: `19:01:32`
- 終了: `19:01:43`
...
- ID: `BrowseScreenUITests.testRemoteSearchRefreshUpdatesResultsAndChipState`
- 概要: Remote Search Refresh Updates Results And Chip State
- 分類: `ui` / `Browse`
- ファイル: `YoutubeFeederUITests/Browse/BrowseScreenUITests.swift`
- 開始: `19:01:43`
- 終了: `19:01:52`
