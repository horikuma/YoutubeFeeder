...
### Summary
- logic tests: 59 cases / 5.589s
- ui tests: 9 cases / 105.293s
- logic areas:
  - Browse: 7 cases / 0.004s
  - Formatting: 5 cases / 0.028s
  - Layout: 4 cases / 0.007s
  - Ordering: 5 cases / 0.004s
  - Parsing: 18 cases / 0.042s
  - Policies: 9 cases / 0.005s
  - Storage: 11 cases / 5.498s
- ui areas:
  - Browse: 7 cases / 67.289s
  - Home: 2 cases / 38.004s
