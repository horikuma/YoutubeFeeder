...
- ドキュメントのみのコミットでも `metrics-latest.md` は更新対象とし、実測を省略した理由を記録する。
...
- 各エントリはコミットやドキュメント更新の単位で追加し、計測値、再試行回数、実測省略理由を一貫した形式で残す。
...
5. 必要な文書 `spec.md`、`architecture.md`、`decisions-log.md` / `decisions-latest.md`、`metrics-log.md` / `metrics-latest.md`、`chat-log.md` / `chat-latest.md`、`rules.md` を更新する。
...
- 上位方針や運用変更: `rules.md`
- 検証コストや性能観測の更新: [metrics-latest.md](metrics-latest.md) と [metrics-log.md](metrics-log.md)
