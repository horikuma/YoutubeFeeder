...
- GitHub Issue を 1 件新規作成しなければならない。
  ...
  例: `./scripts/command-runner.py 'issue-creation' --title 'Git履歴からサルベージして command 例文必須要件を rules / skills へ復元する' --body-file 'llm-temp/20260405-095752-issue-creation-description.md'`
