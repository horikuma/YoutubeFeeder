...
### Summary
- logic tests: 46 cases / 0.054s
- ui tests: 8 cases / 91.467s
- logic areas:
  - Browse: 6 cases / 0.003s
  - Formatting: 2 cases / 0.002s
  - Layout: 4 cases / 0.003s
  - Ordering: 5 cases / 0.003s
  - Parsing: 18 cases / 0.022s
  - Policies: 5 cases / 0.002s
  - Storage: 6 cases / 0.019s
- ui areas:
  - Browse: 6 cases / 53.874s
  - Home: 2 cases / 37.593s

### Logic Tests
- ID: `ChannelBrowseTipsSummaryTests.testBuildHandlesEmptyList`
- 概要: Build Handles Empty List
- 分類: `logic` / `Browse`
- ファイル: `HelloWorldTests/Unit/Browse/ChannelBrowseTipsSummaryTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.001s`
...
- 分類: `logic` / `Formatting`
- ファイル: `HelloWorldTests/Unit/Formatting/AppFormattingTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.002s`

- ID: `AppFormattingTests.testVideoTileBadgeTextIncludesIndexDurationViewCountAndBucket`
- 概要: Video Tile Badge Text Includes Index Duration View Count And Bucket
- 分類: `logic` / `Formatting`
- ファイル: `HelloWorldTests/Unit/Formatting/AppFormattingTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
...
- 分類: `logic` / `Layout`
- ファイル: `HelloWorldTests/Unit/Layout/AppLayoutTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`

- ID: `AppLayoutTests.testRegularWidthLandscapeUsesSplitChannelBrowser`
- 概要: Regular Width Landscape Uses Split Channel Browser
- 分類: `logic` / `Layout`
- ファイル: `HelloWorldTests/Unit/Layout/AppLayoutTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
...
- ID: `AppLayoutTests.testRegularWidthPortraitKeepsSingleColumnChannelBrowser`
- 概要: Regular Width Portrait Keeps Single Column Channel Browser
- 分類: `logic` / `Layout`
- ファイル: `HelloWorldTests/Unit/Layout/AppLayoutTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
...
- 分類: `logic` / `Ordering`
- ファイル: `HelloWorldTests/Unit/Ordering/FeedOrderingTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`
...
- 分類: `logic` / `Parsing`
- ファイル: `HelloWorldTests/Unit/Parsing/ChannelRegistrySnapshotTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`
...
- 分類: `logic` / `Parsing`
- ファイル: `HelloWorldTests/Unit/Parsing/YouTubeChannelResolverTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.001s`
...
- 分類: `logic` / `Parsing`
- ファイル: `HelloWorldTests/Unit/Parsing/YouTubeFeedParserTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`
...
- 分類: `logic` / `Parsing`
- ファイル: `HelloWorldTests/Unit/Parsing/YouTubeSearchServiceTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.003s`
...
- 分類: `logic` / `Policies`
- ファイル: `HelloWorldTests/Unit/Policies/BackSwipePolicyTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`
...
- 分類: `logic` / `Policies`
- ファイル: `HelloWorldTests/Unit/Policies/ChannelVideosAutoRefreshPolicyTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.000s`
...
- 分類: `logic` / `Storage`
- ファイル: `HelloWorldTests/Unit/Storage/FeedCacheMaintenanceTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.004s`
...
- 分類: `logic` / `Storage`
- ファイル: `HelloWorldTests/Unit/Storage/RemoteVideoSearchCacheStoreTests.swift`
- 開始: `18:35:55`
- 終了: `18:35:55`
- 所要時間: `0.004s`
...
### UI Tests
- ID: `BrowseScreenUITests.testAllVideosScreenScrollsWithMockData`
- 概要: All Videos Screen Scrolls With Mock Data
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:00`
- 終了: `18:36:14`
- 所要時間: `14.585s`

- ID: `BrowseScreenUITests.testChannelListShowsNonInteractiveTipsTile`
- 概要: Channel List Shows Non Interactive Tips Tile
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:14`
- 終了: `18:36:20`
...
- ID: `BrowseScreenUITests.testChannelVideosPullToRefreshRefreshesOnlySelectedChannel`
- 概要: Channel Videos Pull To Refresh Refreshes Only Selected Channel
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:20`
- 終了: `18:36:32`
...
- ID: `BrowseScreenUITests.testRemoteSearchChipDismissesOnUserInteraction`
- 概要: Remote Search Chip Dismisses On User Interaction
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:32`
- 終了: `18:36:38`
...
- ID: `BrowseScreenUITests.testRemoteSearchRefreshUpdatesResultsWithDummyTrigger`
- 概要: Remote Search Refresh Updates Results With Dummy Trigger
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:38`
- 終了: `18:36:45`
...
- ID: `BrowseScreenUITests.testRemoteSearchTapShowsChannelTitleAndTriggersAutomaticRefresh`
- 概要: Remote Search Tap Shows Channel Title And Triggers Automatic Refresh
- 分類: `ui` / `Browse`
- ファイル: `HelloWorldUITests/Browse/BrowseScreenUITests.swift`
- 開始: `18:36:45`
- 終了: `18:36:54`
...
- ID: `HomeScreenUITests.testHomePrimaryNavigationAndFeedbackFlow`
- 概要: Home Primary Navigation And Feedback Flow
- 分類: `ui` / `Home`
- ファイル: `HelloWorldUITests/Home/HomeScreenUITests.swift`
- 開始: `18:36:54`
- 終了: `18:37:27`
- 所要時間: `33.205s`

- ID: `HomeScreenUITests.testHomeRefreshUsesMockPathWithoutNetwork`
- 概要: Home Refresh Uses Mock Path Without Network
- 分類: `ui` / `Home`
- ファイル: `HelloWorldUITests/Home/HomeScreenUITests.swift`
- 開始: `18:37:27`
- 終了: `18:37:31`
